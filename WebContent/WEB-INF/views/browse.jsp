	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-lg-12">
	                    ...
	                    <div class="row">
		                    <div class="footer-col col-md-4"><h1 style="text-shadow: 0px 0px 6px rgba(255,255,255,0.7);">Add Student</h1></div>
							<div class="footer-col col-md-4"><hr class="star-light"></div>
	                        <div class="footer-col col-md-4">
		                        <s:property value="%{err}"/>
								<s:property value="%{result}"/>
								<form action="uploadactionsubmit" method="post" enctype="multipart/form-data">
								   <input type="file" name="myFile" style="display:inline" />
								   <input type="submit" class="btn btn-lg btn-block btn-success" style="width: 24%;display:inline" value="Upload"/>
								</form>
							</div>
						</div>
                    </div>
