...
<html lang="en">
	<head>
	    ...
	    <title>Manage Meal Courses</title>
	            ...
	            <div class="row">
	                <div class="col-lg-12 text-center">
	                    ...
	                    <div class="row">
							...
							<div class="footer-col col-md-4"><h1 style="text-shadow: 0px 0px 6px rgba(255,255,255,0.7);">Manage Meal Courses</h1></div>
	                        <div class="footer-col col-md-4"></div>
						</div>
                    </div>
                </div>
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-lg-12" style="width: 50%;">
	                   <h2 style="color: rgba(0,0,0,0.6);text-shadow: 2px 8px 6px rgba(0,0,0,0.2),0px -5px 35px rgba(255,255,255,0.3);">VIEW MEAL COURSES</h2>
						<hr>
						
						<form action="mealCourseInfo"> 
							<h4>Meal Course Id</h4><h4><input type="text" name="id"></h4>
						  	<h4>Meal Course Name</h4><h4><input type="text" name="name"></h4>
						  	<br/><br/>
							<input type="submit" class="btn btn-lg btn-block btn-success" style="width:20%;display:inline" value="Submit"> 
						</form> 
					</div>
					
					<div class="col-lg-12" style="width: 50%;">
						<h2 style="color: rgba(0,0,0,0.6);text-shadow: 2px 8px 6px rgba(0,0,0,0.2),0px -5px 35px rgba(255,255,255,0.3);">Delete/Update Meal Course</h2>
						...
						<table style="width:30%;">
						  ...
						  <tr>
						    <td><h4>${myvar[0]}</h4></td>
						    <td><h4><input type="text" name=name_${myvar[0]} value=${myvar[1]}></h4></td>
							<td><h4><input type="radio" name="check" value=${myvar[0]}></h4></td>
						  </tr> 
						  </s:iterator>
						  <tr>
						    <td><input type="submit" class="btn btn-lg btn-block btn-danger"  name="buttonAction" value="Delete"></td>
							<td><input type="submit" class="btn btn-lg btn-block btn-warning" name="buttonAction" style="margin-left: 25px;" value="Update"></td>
						  </tr>
