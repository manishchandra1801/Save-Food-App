	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-lg-12 text-center">
	                    ...
	                    <div class="row">
		                    <div class="footer-col col-md-4"><h1 style="text-shadow: 0px 0px 6px rgba(255,255,255,0.7);">Update Food Selection and Menu Creation Deadlines</h1></div>
							<div class="footer-col col-md-4"><br/><br/><br/><hr class="star-light"></div>
	                        <div class="footer-col col-md-4">
	                        	<form action="configEdit"> 
									<table style="width:30%"> 
									  ...
									  <tr>   
									  	<th><h4>Menu Creation Deadline</h4></th> 
									    <td><h4 style="color:#000"><input type="datetime" name=manager value=${managerTime}></h4></td>
									  </tr> 
									  <tr>   
									  	<th><h4>Food Selection Deadline</h4></th> 
									    <td><h4 style="color:#000"><input type="datetime" name=student value=${studentTime}></h4></td>
									  </tr> 
									  <tr>
										<td><br/><input type="submit" class="btn btn-lg btn-block btn-success" name="buttonAction" value="Update"></td>
									  </tr>
									</table>  
								</form> 
